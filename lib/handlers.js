...
handlers.index = (data, callback) => {
  if (data.method == "GET") {
    ...
    var templateData = {
      ...
      "head.description":
        "We offer free , simple uptime monitoring for HTTP/HTTPS",
      "body.class": "index"
    };
...
handlers.accountCreate = (data, callback) => {
  if (data.method == "GET") {
    ...
    var templateData = {
      ...
      "head.description": "Signup is easy and takes a few seconds",
...
handlers.favicon = (data, callback) => {
  // Reject any major that isn't a GET
  if (data.method == "GET") {
    // Read in the favicon's data
    helpers.getStaticAsset("favicon.ico", (err, data) => {
      console.log("Favicon function called!!");
      if (!err && data) {
        // Callback the data
...
handlers.public = function(data, callback) {
  ...
  if (data.method == "GET") {
    ...
    //console.log("Public function called!!", trimmedAssetName);
